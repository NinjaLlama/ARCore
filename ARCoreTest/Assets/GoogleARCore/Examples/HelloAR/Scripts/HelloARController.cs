...
namespace GoogleARCore.HelloAR
{
    ...
    public class HelloARController : MonoBehaviour
    {
        ...
        public void Update()
        {
			Debug.Log ("Pointcloud point count = " + Frame.PointCloud.PointCount);
			text1.text = "Point count: " + Frame.PointCloud.PointCount;
			Debug.Log ("Pose info = " + Frame.Pose.position.ToString() + "; " + Frame.Pose.rotation.ToString());
			text2.text = "Camera position: " + Frame.Pose.position.ToString();
